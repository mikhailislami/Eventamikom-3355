...
<nav class="bg-white py-4 shadow">
    <div class="flex justify-center gap-10 text-gray-700 font-medium">
        ...
        <a href="/kontak" class="text-blue-600 font-semibold">Kontak</a>
    </div>
</nav>

<div class="flex justify-center mt-10">
    <div class="bg-white/80 p-10 rounded-xl shadow text-center w-[500px]">

        <h1 class="text-2xl font-bold mb-4">Kontak</h1>

        <p>📧 Email: mikhailislami@students.amikom.ac.id</p>
    </div>
</div>
