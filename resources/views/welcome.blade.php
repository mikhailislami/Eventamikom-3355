    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div
            ...
            <div class="p-6">
                ...
                <h3 class="text-xl font-bold mb-2 group-hover:text-indigo-600 transition">
                    Hackathon 2024: Ultimate Marathon
                </h3>
...
<!-- Category Section -->
<section id="kategori-section" class="max-w-7xl mx-auto px-6 py-20">
    ...
    <div class="mb-16">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div
                class="bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition duration-300 p-6">

                <div class="flex flex-col items-center text-center">

                    <div
                        class="w-14 h-14 rounded-2xl bg-indigo-100 flex items-center justify-center mb-4">
    ...
    <div>
        ...
        <div class="mb-10">
            ...
            <p class="text-slate-500">
                Platform kami didukung partner terpercaya.
            </p>
            ...
            <div
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <img src="{{ $partner->logo_url }}"
                        alt="{{ $partner->name }}"
                        class="w-24 h-24 object-cover rounded-full mb-4 border-4 border-indigo-100">
