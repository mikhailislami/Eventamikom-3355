...
<div class="bg-white rounded-3xl shadow-sm border border-slate-200 p-8">
    ...
    <form action="{{ route('admin-categories.index') }}"
        ...
        <button
            class="bg-blue-500 hover:bg-blue-600 text-white px-8 rounded-xl font-semibold transition">
    ...
    <form action="{{ route('admin-categories.store') }}"
        ...
        <button
            class="bg-green-500 hover:bg-green-600 text-white px-8 rounded-xl font-semibold transition">
                        ...
                        <div class="flex justify-center gap-3">
                            ...
                            <form action="{{ route('admin-categories.update', $category->id) }}"
                                ...
                                <input type="text"
                                       name="name"
                                       value="{{ $category->name }}"
                                       class="border border-gray-300 rounded-lg px-3 py-2 w-40 focus:outline-none focus:ring-2 focus:ring-yellow-400">

                                <button
                                    class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 rounded-lg transition">
